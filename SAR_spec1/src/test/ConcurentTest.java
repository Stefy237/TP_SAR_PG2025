...
public class ConcurentTest {
    public static void main(String[] args) {
		...
		task1.start(() -> {
			...
			byte[] msg1Sent = "Hello ".getBytes();
			byte[] msg2Sent = "Welcome from task1".getBytes();
			channel1.write(msg1Sent, 0, msg1Sent.length);
			channel2.write(msg1Sent, 0, msg1Sent.length);
			channel1.write(msg2Sent, 0, msg1Sent.length);
			channel2.write(msg2Sent, 0, msg1Sent.length);
			byte[] buffer1 = new byte[100];
			byte[] buffer2 = new byte[100];
			int n = channel1.read(buffer1, 0, buffer1.length);
			int m = channel2.read(buffer2, 0, buffer2.length);
			String msg1Received = new String(buffer1, 0, n);
			String msg2Received = new String(buffer2, 0, n);
		...
		task2.start(() -> {
			...
			byte[] msgSent = "Hi from task2".getBytes();
		...
		task3.start(() -> {
			...
			// assert channel != null : "Connect should return a channel";
			byte[] msg1Sent = "Hi from task3".getBytes();
			byte[] msg2Sent = "Hello from task3".getBytes();
			channel1.write(msg1Sent, 0, msg1Sent.length);
			channel2.write(msg2Sent, 0, msg2Sent.length);
			byte[] buffer1 = new byte[100];
			byte[] buffer2 = new byte[100];
			int n = channel1.read(buffer1, 0, buffer1.length);
			int m = channel1.read(buffer2, 0, buffer2.length);
			String msg1Received = new String(buffer1, 0, n);
